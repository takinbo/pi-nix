...
This flake currently packages **pi `v0.64.0`**. The pinned source hash and npm deps hash are both recorded in `flake.nix` and `flake.lock` for fully reproducible builds.

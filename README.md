...
This flake currently packages **pi `v0.75.4`**. The pinned source hash and npm deps hash are recorded in `flake.nix`, and the resolved upstream npm lockfile is used for reproducible builds.
